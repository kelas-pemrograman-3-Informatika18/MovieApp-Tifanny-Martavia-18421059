      ...
      <div class="row">
        ...
        <div class="col">
          <q-banner inline-actions class="text-blue-gray-14">
            ...
            <div>Data Pembelian dan Pemesanan</div>
          </q-banner>
        </div>
      </div>
      </div>
...
export default {
  ...
  data () {
    return {
      columns: [
        { name: 'judulFilm', align: 'center', label: 'Judul Flim', field: 'judulFilm', sortable: true },
  ...
  methods: {
    ...
    confirm (id) {
      this.$q.dialog({
        title: 'Konfirmasi',
        message: 'Apakah anda yakin mau mengkonfirmasi order?',
        cancel: true,
        persistent: true
      }).onOk(() => {
