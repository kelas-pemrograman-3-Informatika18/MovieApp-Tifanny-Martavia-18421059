<template>
  <q-layout view="lHh LpR fFf">
    <q-toolbar unelevated style="height: 60px;" class="bg-white text-blue-grey-14">
      <div class="text-h5 q-ml-lg">Movie APP</div>
      ...
      <q-btn @click="drawer = !drawer" round v-if="$q.screen.xs || $q.screen.sm" icon="menu" flat/>
    </q-toolbar>
    <q-drawer
        v-model="drawer"
        :width="200"
